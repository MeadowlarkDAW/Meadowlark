...
impl AppIcon {
    ...
    fn source(&self) -> &'static [u8] {
        match self {
            ...
            Self::Dev => include_bytes!("../../assets/icons/dev-24.svg"),
            Self::DropdownArrow => include_bytes!("../../assets/icons/dropdown-arrow-20.svg"),
            ...
            Self::PianoRoll => include_bytes!("../../assets/icons/piano-roll-24.svg"),
            ...
            Self::Settings => include_bytes!("../../assets/icons/settings-24.svg"),
