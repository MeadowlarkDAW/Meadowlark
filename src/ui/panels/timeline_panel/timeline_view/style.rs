...
pub struct TimelineViewStyle {
    ...
    pub clip_selected_border_color: Color,
    pub clip_border_width: f32,
    pub clip_selected_border_width: f32,
...
impl Default for TimelineViewStyle {
    fn default() -> Self {
        Self {
            ...
            clip_top_height: 11.0,
            clip_threshold_height: 35.0,
            clip_border_color: Color::rgb(0x20, 0x20, 0x20),
            clip_selected_border_color: Color::rgba(0xff, 0xff, 0xff, 0xff),
            clip_border_width: 1.0,
            clip_selected_border_width: 1.0,
            clip_border_radius: 0.0,
