...
pub fn setup() -> CenterBox {
    ...
    let home_btn = Button::builder().icon_name("mdk-home-symbolic").margin_start(4).build();
    ...
    // TODO: Make this a functional widget.
    let terminal_btn = Button::builder().icon_name("mdk-terminal-2-symbolic").margin_end(4).build();
